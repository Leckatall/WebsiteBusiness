...
$router->addRoute('PUT', '/courses/{id}', [CourseController::class, 'update'], (new ChainedAccess((new TutorAccess), (new CourseAccess))));

$router->addRoute('GET', '/courses/{id}/users', [UserController::class, 'showUsers'], (new CourseAccess));
$router->addRoute('GET', '/api/courses/{id}/users', [UserController::class, 'getUsers'], (new CourseAccess));
...
$router->addRoute('GET', '/api/lessons/{id}/users', [UserController::class, 'getUsersForLesson'], (new LessonAccess));
...
$router->addRoute('PATCH', '/api/lessons/{lessonId}/users/{accountId}', [UserController::class, 'updateUserLessonScore'], (new ChainedAccess((new TutorAccess), (new LessonAccess))));
...
$router->addRoute('DELETE', '/lessons/{id}', [LessonController::class, 'destroy'], (new ChainedAccess((new TutorAccess), (new LessonAccess))));
...
$router->addRoute('GET', '/api/uploads/lessons/{lessonId}/users/{userId}', [FileController::class, 'getAccountFilesForLesson'], (new LessonAccess));
